{
    ...
    'new_page_templates': {
        ...
        'team': {
            ...
            '4': ['s_text_block_title_team_no_padding', 's_text_block', 's_images_wall_team'],
            '5': ['s_text_block_title_team_no_padding', 's_text_block', 's_image_gallery_team', 's_picture_team'],
        },
    },
    'license': 'LGPL-3',
